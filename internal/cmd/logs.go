...
var logsCmd = &cobra.Command{
	Use:   "logs",
	Short: "View megacli logs",
	Long:  `View the logs generated by MegaCLI. This command allows you to see the log output for debugging and monitoring.`,
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if os.IsNotExist(err) {
			log.Warn("Looks like you are not in a megacli project. No logs found.")
			return nil
		}
