...
var dirsCmd = &cobra.Command{
	Use:   "dirs",
	Short: "Print directories used by MegaCLI",
	Long: `Print the directories where MegaCLI stores its configuration and data files.
...
var configDirCmd = &cobra.Command{
	Use:   "config",
	Short: "Print the configuration directory used by MegaCLI",
	Run: func(cmd *cobra.Command, args []string) {
		cmd.Println(filepath.Dir(config.GlobalConfig()))
	},
}
...
var dataDirCmd = &cobra.Command{
	Use:   "data",
	Short: "Print the data directory used by MegaCLI",
	Run: func(cmd *cobra.Command, args []string) {
		cmd.Println(filepath.Dir(config.GlobalConfigData()))
	},
}
