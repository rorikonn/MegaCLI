...
curl https://example.com | megacli run "Summarize this website"

# Read from a file
megacli run "What is this code doing?" <<< main.go

# Redirect output to a file
megacli run "Generate a README for this project" > MY_README.md

# Run in quiet mode (hide the spinner)
megacli run --quiet "Generate a README for this project"

# Run in verbose mode (show logs)
megacli run --verbose "Generate a README for this project"

# Continue a previous session
megacli run --session {session-id} "Follow up on your last response"

# Continue the most recent session
megacli run --continue "Follow up on your last response"
...
// prefix returned by megacli session list.
