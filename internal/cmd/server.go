...
import (
	...
	megaclilog "github.com/megacli/megacli/internal/log"
...
var serverCmd = &cobra.Command{
	Use:   "server",
	Short: "Start the MegaCLI server",
	RunE: func(cmd *cobra.Command, _ []string) error {
		...
		if term.IsTerminal(os.Stderr.Fd()) {
			megaclilog.Setup(logFile, debug, os.Stderr)
		} else {
			megaclilog.Setup(logFile, debug)
		}
		...
		slog.Info("Starting MegaCLI server...", "addr", serverHost)
