...
func TestCrushInfo_ConfigFiles(t *testing.T) {
	...
	cfg := config.NewTestStore(
		...
		"/home/user/.config/megacli/megacli.json",
		"/project/.megacli/megacli.json",
	)
	output := buildCrushInfo(cfg, nil, nil, nil, nil)
	require.Contains(t, output, "[config_files]")
	require.Contains(t, output, "/home/user/.config/megacli/megacli.json")
	require.Contains(t, output, "/project/.megacli/megacli.json")
}
...
func TestCrushInfo_Options(t *testing.T) {
	...
	cfg := config.NewTestStore(&config.Config{
		...
		Options: &config.Options{
			DataDirectory:        "/Users/user/project/.megacli",
			Debug:                true,
	...
	require.Contains(t, output, "data_directory = /Users/user/project/.megacli")
...
func TestCrushInfo_ConfigStaleness_Clean(t *testing.T) {
	...
	dir := t.TempDir()
	configPath := filepath.Join(dir, "megacli.json")
