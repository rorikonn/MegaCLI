...
func TestRegisterAndList(t *testing.T) {
	...
	err := Register("/home/user/project1", "/home/user/project1/.megacli")
	if err != nil {
	...
	if projects[0].DataDir != "/home/user/project1/.megacli" {
		t.Errorf("Expected data_dir /home/user/project1/.megacli, got %s", projects[0].DataDir)
	}

	// Register another project
	err = Register("/home/user/project2", "/home/user/project2/.megacli")
	if err != nil {
		t.Fatalf("Register failed: %v", err)
	}
...
func TestRegisterUpdatesExisting(t *testing.T) {
	...
	err = Register("/home/user/project1", "/home/user/project1/.megacli-new")
	if err != nil {
		t.Fatalf("Register failed: %v", err)
	}
	...
	if projects[0].DataDir != "/home/user/project1/.megacli-new" {
...
func TestProjectsFilePath(t *testing.T) {
	...
	expected := filepath.Join(tmpDir, "megacli", "projects.json")
...
func TestRegisterWithParentDataDir(t *testing.T) {
	...
	if projects[0].DataDir != "/home/user/monorepo/.megacli" {
		t.Errorf("Expected data_dir /home/user/monorepo/.megacli, got %s", projects[0].DataDir)
	}
}
...
func TestRegisterWithExternalDataDir(t *testing.T) {
	...
	// Register a project where .megacli is in a completely different location.
	// e.g., project at /home/user/project but data stored at /var/data/megacli/myproject
	err := Register("/home/user/project", "/var/data/megacli/myproject")
	if err != nil {
		t.Fatalf("Register failed: %v", err)
	}
	...
	if projects[0].DataDir != "/var/data/megacli/myproject" {
		t.Errorf("Expected data_dir /var/data/megacli/myproject, got %s", projects[0].DataDir)
	}
}
