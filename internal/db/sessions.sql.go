...
INSERT INTO sessions (
    ...
    strftime('%s', 'now'),
    strftime('%s', 'now')
) RETURNING id, parent_session_id, title, message_count, prompt_tokens, completion_tokens, cost, updated_at, created_at, summary_message_id, todos, active_agent
`
...
SELECT id, parent_session_id, title, message_count, prompt_tokens, completion_tokens, cost, updated_at, created_at, summary_message_id, todos, active_agent
FROM sessions
...
const updateSessionActiveAgent = `-- name: UpdateSessionActiveAgent :exec
UPDATE sessions
SET
    active_agent = ?
WHERE id = ?
...
type UpdateSessionActiveAgentParams struct {
	ActiveAgent string `json:"active_agent"`
	ID          string `json:"id"`
}

func (q *Queries) UpdateSessionActiveAgent(ctx context.Context, arg UpdateSessionActiveAgentParams) error {
	_, err := q.exec(ctx, q.updateSessionActiveAgentStmt, updateSessionActiveAgent, arg.ActiveAgent, arg.ID)
	return err
}
