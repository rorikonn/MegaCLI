...
import (
	...
	"github.com/megacli/megacli/internal/ui/diffview"
)
...
type Styles struct {
	...
	Header struct {
		...
		LogoGradCanvas    lipgloss.Style // Canvas for the compact "megacli" gradient
		LogoGradFromColor color.Color    // "megacli" wordmark gradient start
		LogoGradToColor   color.Color    // "megacli" wordmark gradient end
	}
	...
	Logo struct {
		...
		SmallGradFromColor color.Color    // Small "megacli" wordmark gradient start
		SmallGradToColor   color.Color    // Small "megacli" wordmark gradient end
	}
