...
import (
	...
	"github.com/megacli/megacli/internal/diff"
	"github.com/megacli/megacli/internal/fsext"
	"github.com/megacli/megacli/internal/hooks"
...
func NewToolMessageItem(
	...
	case megatool.ShowFileToolName:
		item = NewShowFileToolMessageItem(sty, toolCall, result, canceled)
	default:
