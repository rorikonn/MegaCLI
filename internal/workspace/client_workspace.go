...
func (w *ClientWorkspace) RetryFailedMCPs(ctx context.Context) (int, []error) {
	return 0, nil
}
...
func (w *ClientWorkspace) GetOrchestrator() *orchestrator.Orchestrator {
	return nil
}

func (w *ClientWorkspace) GetIPCManager() *ipc.Manager {
	return nil
}
