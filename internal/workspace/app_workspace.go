...
import (
	...
	mcptools "github.com/megacli/megacli/internal/agent/tools/mcp"
...
func (w *AppWorkspace) AgentCurrent() string {
	...
	return w.app.AgentCoordinator.CurrentAgent()
}

func (w *AppWorkspace) AgentAvailable() []string {
	if w.app.AgentCoordinator == nil {
		return nil
	}
...
func (w *AppWorkspace) GetOrchestrator() *orchestrator.Orchestrator {
	return w.app.Orchestrator
}

func (w *AppWorkspace) GetIPCManager() *ipc.Manager {
	return w.app.IPCManager
}
